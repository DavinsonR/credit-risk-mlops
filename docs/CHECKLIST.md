...
| **Las dos claves de LLM** | Los cinco brazos corrieron. Resultado en la [quinta revisión del ADR 0009](adr/0009-la-plantilla-gana-al-llm.md) |
| CI en verde | Última corrida `3939af3`: success |

Quedan **dos**. El primero necesita Power BI Desktop; el segundo no puede hacerlo nadie
más que tú, y es el que más vale en una entrevista.

---

# 1 · Abrir el informe de Power BI
...
## 1.2 · Activar las DOS banderas de vista previa
...
## 1.4 · Si no abre — esto es lo importante
...
1. **"La característica de vista previa no está habilitada"** → vuelve al 1.2.
...
## 1.7 · Lo que vas a tener que ajustar a mano
...
# 2 · Los veinticuatro `_(escribir: ...)_` de NOTES.md
...
| # | Qué | Tiempo | Quién |
|---|---|---|---|
| 1 | Abrir el informe de Power BI | 1 hora | Solo tú (hace falta Desktop) |
| 2 | Los `_(escribir: ...)_` | 1–2 horas | Solo tú, y por eso existen |

**Nada de esto bloquea mostrar el proyecto.** CI en verde, 261 tests, 10 gates, 14 ADRs,
